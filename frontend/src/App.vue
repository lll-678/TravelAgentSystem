...
const navItems = [
  ...
  { path: "/demo", label: "答辩演示", kicker: "02", description: "演示链路、算法 trace 和关系图" },
  { path: "/profile", label: "个人偏好", kicker: "03", description: "用户画像、兴趣和行为反馈" },
  { path: "/map", label: "地图与目的地", kicker: "04", description: "全国目的地 POI 与内部地图图层" },
  ...
  { path: "/diaries", label: "游记社区", kicker: "08", description: "游记列表、查询、浏览、评分和评论" },
  { path: "/diaries/create", label: "发布与 AIGC", kicker: "09", description: "发布游记并生成 Agent 分镜和模拟视频" },
  { path: "/foods", label: "美食推荐", kicker: "10", description: "美食检索、推荐和路线预览" },
